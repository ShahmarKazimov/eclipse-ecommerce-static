...
const Hamilton = () => {
  ...
  const loadProducts = () => {
    ...
    const hamiltonProducts = myData.filter(product => product.title.toLowerCase().includes('hamilton'));
    setProductsData(hamiltonProducts);
    setFilteredProducts(hamiltonProducts);
  };
      ...
      <div className={selectedProduct ? "blurred" : ""}>
        <div className="flex flex-col justify-between items-center">
          <div className="text-center w-full">
            <h2 className="text-3xl font-bold inline-block">Hamilton</h2>
          </div>

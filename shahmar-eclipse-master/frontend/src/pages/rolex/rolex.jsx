...
const Rolex = () => {
  ...
  const loadProducts = () => {
    ...
    const rolexProducts = myData.filter(product => product.title.toLowerCase().includes('rolex'));
    setProductsData(rolexProducts);
    setFilteredProducts(rolexProducts);
  };
      ...
      <div className={selectedProduct ? "blurred" : ""}>
        <div className="flex flex-col justify-between items-center">
          <div className="text-center w-full">
            <h2 className="text-3xl font-bold inline-block">Rolex</h2>
          </div>

...
const Cartier = () => {
  ...
  const loadProducts = () => {
    ...
    const cartierProducts = myData.filter(product => product.title.toLowerCase().includes('cartier'));
    setProductsData(cartierProducts);
    setFilteredProducts(cartierProducts);
  };
      ...
      <div className={selectedProduct ? "blurred" : ""}>
        <div className="flex flex-col justify-between items-center">
          <div className="text-center w-full">
            <h2 className="text-3xl font-bold inline-block">Cartier</h2>
          </div>

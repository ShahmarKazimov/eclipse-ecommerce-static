...
const Ulysse = () => {
  ...
  const loadProducts = () => {
    ...
    const ulysseProducts = myData.filter(product => product.title.toLowerCase().includes('ulysse'));
    setProductsData(ulysseProducts);
    setFilteredProducts(ulysseProducts);
  };
      ...
      <div className={selectedProduct ? "blurred" : ""}>
        <div className="flex flex-col justify-between items-center">
          <div className="text-center w-full">
            <h2 className="text-3xl font-bold inline-block">Ulysse Nardin</h2>
          </div>
